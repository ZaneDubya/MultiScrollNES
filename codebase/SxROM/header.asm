...
; This header designates SxROM (MMC1) with 64kb ROM, 8kb CHRRAM, and 8kb PRGRAM.
.byte $4e,$45,$53,$1a 		; NES/eof
.byte $04 					; # of 16kb PRG ROM
...
.byte $00 					; # 8kb PRG RAM, $00 infers 1 x 8kb for compatibility
.byte $00 					; flags9
