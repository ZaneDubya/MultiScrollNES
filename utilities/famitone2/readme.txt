FamiTone2 audio library v1.0 by Shiru 01.14
...
- Allowed notes are C-1..B-5, Note Cut (rest note)
...
- Up to 12 samples with total size of ~16K
- Only samples of instrument 0 are supported, they should be all assigned
  to octave 3
