...
namespace Core.Graphics
{
    public class SpriteBatchExtended : DrawableGameComponent
    {
        ...
        public override void Initialize()
        {
            ...
            _effect = Core.Library.Content.Load<Effect>("NES_PTHE");
        ...
        {
            _effect.Parameters["ProjectionMatrix"].SetValue(Library.ProjectionMatrixScreen);
        ...
        public void GUIDrawString(SpriteFont font, string text, Vector2 location, Color? color = null)
        {
            if (_textRenderer == null)
                _textRenderer = new TextRenderer(Game.GraphicsDevice, Core.Library.Content.Load<SpriteFont>("Arial12"));
