/*  CutsceneMode displays full-screen text and conversations in the game.
    It also has a fairly simple scripting system that can set flags, read flags,
    branch, and display alternate text and conversation options.
    ...
    Operations:
        ...
        03  2 byte jump always.
            03 jj jj
        04  Display full screen of text
            04 tt tt
        14  Display background index = value0
            14 vv
        24  Display portrait index = valu0 on left.
            24 vv
        34  Display portrait index = valu0 on right.
            34 vv
        44  Display portrait index = valu0 centered.
            44 vv
