...
namespace Core.GUI.Content
{
    ...
    {
        private TextBox m_Parent;
        public TextBoxRenderRule(TextBox parent)
        {
            m_Parent = parent;
        }
        ...
        public override void Draw()
        {
            ...
            {
                Rectangle source = new Rectangle(0, 0, RenderedText.Width, RenderedText.Height);
                RenderManager.SpriteBatch.GUIDrawSprite(RenderedText, Area, source, Color.White);
            }
        ...
        public void RenderSelection(Rectangle renderArea) {
            ...
            for (var i = start; i < end; i++) {
                ...
                RenderManager.SpriteBatch.GUIDrawSprite(RenderManager.SelectionColor, rectangle, source, Color.White);
            }
        }
        ...
        public void BakeText()
        {
            ...
            Core.Graphics.TextureBaker textureBaker = new Core.Graphics.TextureBaker(
                RenderManager.GraphicsDevice,
                Area.Width,
                Area.Height,
                Core.Graphics.TextureBaker.RenderState.Fill);
